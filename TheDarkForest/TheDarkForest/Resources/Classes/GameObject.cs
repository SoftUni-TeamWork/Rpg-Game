namespace TheDarkForest.Resources.Classes
{
    ...
    public abstract class GameObject : IGameObject, IMove, IAttack
    {
        ...
        public GameObject(int healthPoints, int attackPoints, int defencePoints, int currentLevel, Position position)
        {
        ...
        public virtual void Attack(GameObject gameObject, AttackType attackType)
        {
            throw new NotImplementedException();
        }
    }
